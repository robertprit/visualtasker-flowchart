...
public data class FlowchartColorTokens(
    ...
    public val eventNodeFill: Color = Color(0xFF3A341E),
    public val actionNodeFill: Color = Color(0xFF3E6F91),
    public val controlNodeFill: Color = Color(0xFF3C2D22),
    public val logicNodeFill: Color = Color(0xFF2B3A4A),
    public val variableNodeFill: Color = Color(0xFF314034),
    public val feedbackNodeFill: Color = Color(0xFF4A2D40),
    public val inputNodeFill: Color = Color(0xFF4B6F8F),
    public val perceptionNodeFill: Color = Color(0xFF3F735F),
    public val textNodeFill: Color = Color(0xFF5D6FA8),
    public val fileNodeFill: Color = Color(0xFF8B6F42),
    public val systemNodeFill: Color = Color(0xFF6B7280),
    public val chromeTabNodeFill: Color = Color(0xFF2F6FDB),
    public val taskerNodeFill: Color = Color(0xFF7C5AC7),
    public val shellNodeFill: Color = Color(0xFF207A4B),
    public val chartNodeFill: Color = Color(0xFFB4772F),
    public val runtimeNodeFill: Color = Color(0xFF686E78),
    public val debugNodeFill: Color = Color(0xFF75617A),
    ...
    public val succeededStroke: Color = Color(0xFF2E7D32),
    public val skippedStroke: Color = Color(0xFF8C8F99),
    public val failedStroke: Color = Color(0xFFBA1A1A),
    public val traversedEdge: Color = Color(0xFF2E7D32),
    public val edge: Color = Color(0xFF596173),
    public val branchEdge: Color = Color(0xFF6750A4),
    public val dataEdge: Color = Color(0xFF0B57D0),
...
public data class FlowchartShapeTokens(
    ...
    public val edgeStrokeWidthDp: Float = 2.6f,
...
public data class FlowchartHostCallbacks(
    ...
    public val onNodeDragFinished: (FlowNodeId, Set<FlowNodeId>, FlowPoint) -> Unit = { _, _, _ -> },
